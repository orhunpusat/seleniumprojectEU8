...
public class T2_getText_getAttribute {
    ...
    public static void main(String[] args) {
        ...
        String expectedRememberMeLabel = "Remember ne on this computer";
        ...
        if (actualForgotPasswordLinkText.equals(expectedForgotPasswordLinkText)){
            ...
            System.out.println("Forgot password link verificition FAİLED");
        }
        ...
        if (actualForgotPasswordLinkText.equals(expectedForgotPasswordLinkText)){
            System.out.println("HREF attribute value verificition PASSED");
        }else {
            System.out.println("HREF attribute value verificition FAİLED");
        }
